...
// вместо отдельных кружков — одна стеклянная капсула #cornerStack. Сюда сами
// встают ГЛОБАЛЬНЫЕ кнопки: #bgFab (site-bg.js) и #themeFab (profile-menu.js) —
// оба модуля зовут cornerStack.ensure() и аппендятся внутрь, порядок сверху вниз
// держат order-правила в corner-stack.css.
// На «Портфелях» капсула скрыта (corner-stack.css): pfxFabSync (portfolios-tabs.js)
// ФИЗИЧЕСКИ забирает #bgFab/#themeFab в кластер панели действий #pfActBar и
// возвращает их сюда при уходе с вкладки; слот #cstPage — наследие, всегда пуст.
