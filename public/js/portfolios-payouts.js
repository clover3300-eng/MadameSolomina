...
(function () {
    ...
    function pfcmCardHtml(demoMap) {
        ...
        return '<div class="dash2-card pf-card2 pf-calmblk">' +
            ...
            // ХРОМ ИДЁТ ПЕРВЫМ, месяц — за ним (правило 2026-08-04): если правый угол
            // виджета занят собственным контентом, шестерёнка и корзина встают СЛЕВА
            // от него — как у «Избранного», «Карты рынка», «Списка портфелей» и
            // карточек терминала. Здесь пара стояла справа от стрелок месяца и
            // отжимала их от края.
            PF.pfCardHead(monthCnt || '', 'Календарь выплат', '',
                '<div class="pfcm-head-r">' + PF.pfdInChromeHtml('calm') + nav + '</div>') +
            next +
