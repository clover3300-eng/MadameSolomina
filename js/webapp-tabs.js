...
function handleSearchKeyup(event) {
    // Оригинальный обработчик в коде — вызывает performSearch
    if (event.keyCode === 13) {
...
// Top search bar keyup — тот же performSearch
function handleTopSearchKeyup(event) {
    ...
    // Также обработаем живой поиск по мере ввода (опционально)
}

// Make collapse/expand search work (legacy compat)
