...
(function () {
    ...
    PF.CHECK_SVG = CHECK_SVG; PF.CHEV_SVG = CHEV_SVG; PF.EYEOFF_SVG = EYEOFF_SVG; PF.EYE_SVG = EYE_SVG;
        PF.PFCM_WD = PFCM_WD; PF.PFDGRID_SVG = PFDGRID_SVG; PF.PFX_TABS = PFX_TABS;
    PF.UNDO_SVG = UNDO_SVG; PF.XMARK_SVG = XMARK_SVG; PF.cardHtml = cardHtml; PF.closeImpMenus = closeImpMenus;
    PF.collectUpcomingPayouts = collectUpcomingPayouts; PF.paymentCalendarHtml = paymentCalendarHtml; PF.pfCardHead = pfCardHead;
    PF.pfConfirm = pfConfirm; PF.pfcmCardHtml = pfcmCardHtml;                     PF.pfwDivsHtml = pfwDivsHtml;         PF.pfxBgRowHtml = pfxBgRowHtml;
    ...
    PF.pfxVisRowsHtml = pfxVisRowsHtml; PF.pfxWide = pfxWide; PF.plural = plural;     PF.renderSmooth = renderSmooth; PF.summaryCardHtml = summaryCardHtml;
    ...
    PF.UPLOAD_SVG = UPLOAD_SVG; PF.XLSTBL_SVG = XLSTBL_SVG; PF.assetDisplayName = assetDisplayName; PF.backupWrapHtml = backupWrapHtml;
    PF.collectTrades = collectTrades; PF.daysUntilText = daysUntilText; PF.eyeWrapHtml = eyeWrapHtml; PF.renderNoAnim = renderNoAnim;
