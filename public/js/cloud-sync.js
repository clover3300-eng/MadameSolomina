...
(function () {
    ...
    var WATCH = [
        ...
        // 'pf_trades_hidden_v1' снят 2026-07-29: скрывать журнал больше нечем
        // (тумблер жил в меню «Видимость»), ключ подчищает portfolios-trades.js
        ...
        'sb_widget_v1',         // какой виджет стоит в слоте колонки вместо табло капитала (js/sidebar-ctx.js)
        'sb_note_v1',           // текст виджета «Заметка» в колонке — он и есть данные пользователя
