...
(function () {
    ...
    function scnTapeWants(n) {
        ...
        // лента нужна раскрытому блоку «Последние сделки» в стакане карточки
    ...
    PF.pftSceneHtml = function () {
        ...
        var body = s.meta
            ? scnHeroHtml(n, s) +
              ...
              '<div class="dock" id="btScnDock">' + scnDockHtml() + '</div>'
            : scnHelloHtml();
