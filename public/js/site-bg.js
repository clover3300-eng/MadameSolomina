...
(function () {
    ...
    // список, персист и классы на <body>. Дефолт с 2026-08-05 — «Рассвет» (был
    // «Бумага», до неё «Аврора» и «Мозаика»): тёплая подложка не спорит с
    // карточками так, как холодные всполохи «Авроры», но и не выглядит пустой
    // бумагой. У кого ключ уже выбран, тот остаётся на своём варианте — дефолт
    // меняет картину только новым.
    ...
    var BG_LIST = [
        ...
        // «Витраж» — ровно тот фон, на котором нарисован раунд overview3: под
        // стеклянными виджетами и стеклянной колонкой сайдбара он и задуман.
        { id: 'vitrazh',  name: 'Витраж',     sub: 'фон мокапа: мята и сирень' }
    ];
