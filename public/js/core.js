...
function toggleInterestingMore() {
    ...
    if (window.Telegram?.WebApp?.HapticFeedback) {
        ...
        function toggleTheme() {
            ...
            // На Главной тема принудительно тёмная (enforceHomeDarkTheme в
            // webapp-tabs.js) — не переключаем, чтобы не сбить user_theme.
            if (body.classList.contains('tab-home')) return;
        ...
        function initTheme() {
            ...
            // Главная всегда тёмная (enforceHomeDarkTheme в webapp-tabs.js);
            // initTheme зовётся повторно из loadData — не даём вернуть светлую
